...
<p><a href='my_posts.php?u_id='$user_id'><strong>My Posts&nbsp;</strong>($posts)</a></p>
...
<h2>All Registered Users </h2> <br/><br/>

<?php   
$get_memers ="select * from users";
$run_memers = mysqli_query($con,$get_memers);

while($row=mysqli_fetch_array($run_memers)){
$user_id = $row['user_id'];
$u_name = $row['u_name'];
$u_image = $row['u_image'];
...
<img src='user/user_images/$u_image' width='100px' height='100px' title='$u_name'  style='margin:5px;'/>
</a>
 ";
